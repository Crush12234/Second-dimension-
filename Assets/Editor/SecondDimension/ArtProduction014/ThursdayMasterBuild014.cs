...
namespace SecondDimension.Editor.ArtProduction014
{
    public static class ThursdayMasterBuild014
    {
        ...
        [MenuItem("Second Dimension/Build/Windows Owner Review 014")]
        ...
        private static void Build()
        {
            ...
            string outputFolder = Path.Combine(projectRoot, "Builds", "Windows_Owner_Review_014");
            ...
            File.WriteAllText(
                Path.Combine(outputFolder, "BUILD_SUMMARY_014.txt"),
                new StringBuilder()
                    .AppendLine("SECOND DIMENSION — WINDOWS OWNER REVIEW 014")
            ...
            File.WriteAllText(
                Path.Combine(outputFolder, "README_PLAY_BUILD_014.txt"),
            ...
            Debug.Log("Windows owner-review build 014 succeeded: " + outputPath);
        }

        private static void WriteHashes(string outputFolder)
        {
            string manifestPath = Path.Combine(outputFolder, "BUILD_SHA256_014.txt");
